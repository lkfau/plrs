...
const Schedules = () => {
  ...
  useEffect(() => {
    ...
    fetchData();/* 
    axios.get('http://54.210.243.185/buildings')
      .then(response => {
        // Assuming your server responds with an array of locations
        const { data } = response;
        // Extract only the building names from the response data
...
// Call the function to execute the HTTP request
fetchData();
