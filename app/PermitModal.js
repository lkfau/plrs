  ...
  return (
    ...
    >
      <TouchableOpacity
        ...
        onPressOut={onClose}
      >
        <View style={{ display: 'flex', backgroundColor: '#fff', width: 300, height: 400, padding: 10, borderRadius: 10 }}>
          <ScrollView>
          ...
          <TouchableOpacity onPress={savePermits}><Text>Save permits</Text></TouchableOpacity>
        </View>
      </TouchableOpacity>
    </Modal>
  )
